...
if lang == 'cat':
    msgText = MIMEText('Please join us for a celebration of our wedding in Barcelona, September 7th 2019')
else:
    msgText = MIMEText('Esteu convidats a celebrar el nostre casament a Barcelona, el 7 se setembre del 2019')
